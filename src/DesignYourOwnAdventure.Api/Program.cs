...
using DesignYourOwnAdventure.Core.Extensions;
using DesignYourOwnAdventure.Infrastructure.Extensions;
...
builder.Services.AddSwaggerGen(x => x.SwaggerDoc("v1",
	new OpenApiInfo { Title = "Create Your Own Adventure", Version = "v1" }));
